...
EXPECTED_MAIN_FIGURES = (
    ...
    "figures/flow_c2_pooled_and_within_paper.png",
    "figures/c2_branching_sensitivity_ci_clip_chamfer.png",
    "figures/c2_delta_h_branching_correlation_ci_clip_chamfer.png",
    "figures/flow_c2_pooled_and_within_paper_ci.png",
    "figures/c2_plife_plus_branching_sensitivity.png",
    "figures/c2_plife_plus_delta_h_branching_correlation.png",
    "figures/c2_plife_plus_clip_chamfer_association_clean.png",
...
SUPPORTING_TABLES = (
    ...
    "synthetic_calibration/tau_profile_ci.csv",
    ...
    "c2_branching/branching_pair_details.csv",
    "c2_branching/branching_scores_clip_chamfer.csv",
    "c2_branching/branching_pair_details_clip_chamfer.csv",
