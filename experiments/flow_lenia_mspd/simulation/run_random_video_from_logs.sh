...
input_dir="${INPUT_DIR:-experiments/flow_lenia_mspd/checkpoints/test_run_longer/apf_logs}"
output="${OUTPUT:-experiments/flow_lenia_mspd/figures/test_run_longer.mp4}"
