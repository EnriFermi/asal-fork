...
selected_optimization_root="experiments/paper_check_flow_lenia/checkpoints_lockheed_1_openai_es_fixed_init_9opt_completed_robust_c1/optimization"
generated_cfg="experiments/paper_suite/config_flowlenia_lockheed_1_openai_es_fixed_init_9opt_completed_robust_c1.yaml"
result_root="analysis/results/paper_suite_flowlenia_lockheed_1_openai_es_fixed_init_9opt_completed_robust_c1"
apf_root="experiments/paper_check_flow_lenia/checkpoints_lockheed_1_openai_es_fixed_init_9opt_completed_robust_c1/c1_lagrangian_apf_300k_train50_4seeds"
...
log_line() {
  line="$(timestamp) [flowlenia-fixed-init-completed-robust-c1] $*"
  echo "${line}"
  printf '%s\n' "${line}" >> "${master_log}"
}
...
echo "Flow-Lenia lockheed_1 OpenAI-ES fixed-init completed-runs robust C1"
